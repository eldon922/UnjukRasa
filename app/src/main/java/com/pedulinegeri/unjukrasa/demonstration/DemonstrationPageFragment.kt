...
//    TODO dev
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvDiscussion.apply {
            ...
            this.adapter = DiscussionListAdapter(arrayListOf("abcde", "abcde", "abcde", "abcde", "abcde", "abcde"), findNavController())
        }
        ...
        binding.rvPerson.apply {
            ...
            this.adapter = PersonListAdapter(arrayListOf("Inisiator", "Koordinator", "Dukung", "Ikut", "Koordinator", "Koordinator"), findNavController())
        }
        ...
        binding.toolbar.setOnMenuItemClickListener {
            when (it.itemId) {
                R.id.action_edit -> {
                    findNavController().navigate(DemonstrationPageFragmentDirections.actionDemonstrationPageFragmentToNewDemonstrationPageFragment(true))
                }
        ...
        binding.chipParticipant.setOnClickListener {
            findNavController().navigate(DemonstrationPageFragmentDirections.actionDemonstrationPageFragmentToParticipationListBottomSheetDialog(ParticipationListBottomSheetDialog.TypeList.PARTICIPANT))
        }

        binding.chipUpvote.setOnClickListener {
            findNavController().navigate(DemonstrationPageFragmentDirections.actionDemonstrationPageFragmentToParticipationListBottomSheetDialog(ParticipationListBottomSheetDialog.TypeList.UPVOTE))

        }

        binding.chipDownvote.setOnClickListener {
            findNavController().navigate(DemonstrationPageFragmentDirections.actionDemonstrationPageFragmentToParticipationListBottomSheetDialog(ParticipationListBottomSheetDialog.TypeList.DOWNVOTE))

        }

        binding.chipShare.setOnClickListener {
            findNavController().navigate(DemonstrationPageFragmentDirections.actionDemonstrationPageFragmentToParticipationListBottomSheetDialog(ParticipationListBottomSheetDialog.TypeList.SHARE))
        }
