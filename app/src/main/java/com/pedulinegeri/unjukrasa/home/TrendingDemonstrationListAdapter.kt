...
class TrendingDemonstrationListAdapter(
    private val mainNavController: NavController
) :
    RecyclerView.Adapter<TrendingDemonstrationListAdapter.ViewHolder>() {

    private val dataSet = arrayListOf<Demonstration>()

    inner class ViewHolder(private val binding: TrendingDemonstrationListItemBinding) :
